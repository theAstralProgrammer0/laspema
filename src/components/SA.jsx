  ...
  return (
    <div className="w-full bg-slate-200 py-16 px-4 ">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
            ...
            <a href="https://web.facebook.com/jidesanwooluofficial/?_rdc=1&_rdr" target="blank"><img className="w-[300px] h-[300px] mx-auto my-4 rounded-full shadow-2xl hover:scale-105 ease-in-out duration-300" src={sa_url} alt='/' /></a>
        </div>
    </div>
  )
}
